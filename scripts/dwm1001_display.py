...
class DisplayInRviz:
    ...
    def start(self):
        rospy.Subscriber("/agv/uwb/anchor0", Anchor, self.Anchor0callback)
        rospy.Subscriber("/agv/uwb/anchor1", Anchor, self.Anchor1callback)
        rospy.Subscriber("/agv/uwb/anchor2", Anchor, self.Anchor2callback)
        rospy.Subscriber("/agv/uwb/anchor3", Anchor, self.Anchor3callback)
        rospy.Subscriber("/agv/uwb/tag"    , Tag   , self.TagCallback)
        rospy.spin()
